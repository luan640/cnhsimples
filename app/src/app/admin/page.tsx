...
import { updateDefaultPlatformSplitAction } from '@/app/admin/actions'
...
export default async function AdminDashboard() {
  const [stats, pendingInstructors, pendingWithdrawals, revenueSplitSettings] = await Promise.all([
    getAdminStats(),
  ...
  return (
    <div className="p-6 space-y-8">
      ...
      <RevenueSplitSettingsCard
        title="Split padrão da plataforma"
        description="Define o percentual padrão que fica com a plataforma em novos pagamentos. Instrutores sem configuração própria herdam este valor."
        defaultPlatformSplitPercent={defaultPlatformSplitPercent}
        currentPlatformSplitPercent={defaultPlatformSplitPercent}
        inherited={false}
        showInheritanceOptions={false}
        onSave={updateDefaultPlatformSplitAction}
      />
        ...
        {pendingInstructors.length === 0 ? (
          ...
          >
            ...
            <p className="text-sm mt-1" style={{ color: '#64748B' }}>
              Nenhum instrutor aguardando análise.
            </p>
          </div>
        ) : (
          <div
            ...
            <table className="w-full text-sm">
              <thead>
                <tr style={{ borderBottom: '1px solid #E2E8F0', background: '#F8FAFC' }}>
                  ...
                  <th
                    className="text-left px-4 py-3 font-semibold hidden lg:table-cell"
                    style={{ color: '#64748B' }}
                  >
                    Cadastro
                  </th>
              ...
              <tbody>
                {pendingInstructors.map((inst, i) => (
                  <tr key={inst.id} style={{ borderTop: i > 0 ? '1px solid #F1F5F9' : undefined }}>
