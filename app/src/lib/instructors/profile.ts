...
function buildMetadata(payload: InstructorSignupPayload) {
  return {
    ...
    cnh_number: payload.cnhNumber || null,
    cnh_expires_at: payload.cnhExpiresAt || null,
    detran_credential_number: payload.detranCredentialNumber || null,
    detran_credential_expires_at: payload.detranCredentialExpiresAt || null,
    cep: payload.cep,
